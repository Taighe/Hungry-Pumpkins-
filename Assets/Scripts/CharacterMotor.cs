...
public class CharacterMotor : MonoBehaviour 
{
	...
	public class CharacterMotorMovement 
	{
		...
		[HideInInspector]
		public float o_maxForwardSpeed;
		[HideInInspector]
		public float o_maxSidewaysSpeed;
		[HideInInspector]
		public float o_maxBackwardsSpeed;
	...
	void Start()
	{
		movement.o_maxForwardSpeed = movement.maxForwardSpeed;
		movement.o_maxSidewaysSpeed = movement.maxSidewaysSpeed;
		movement.o_maxBackwardsSpeed = movement.maxSidewaysSpeed;
	}
